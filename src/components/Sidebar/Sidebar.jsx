  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <div className="logo">
          <a
            href="https://frontend-institution.azurewebsites.net"
              ...
              if (!prop.redirect && prop.visible && prop.path != null) {
                ...
                return (
                  <li
                    key={key}
                    className={`${
                      this.state[prop.name] ? "parent open" : "parent"
                    }`}
                    onClick={e => {
                      if (
                        e.target.innerText !==
                  ...
                  >
                    <span
                      className={
                        this.state[prop.name] ? "arrow rotate" : "arrow"
                      }
                    />
                    <i className={prop.icon} />
                    <div>{prop.name}</div>
                      ...
                      <ul className="nav">
                        {prop.children.map((cprop, ckey) => {
                          if (
                            ...
                            return (
                              <li
                                className={this.activeRoute(cprop.path)}
                                key={key + ckey}
                              >
                                <NavLink
                                  to={cprop.path}
