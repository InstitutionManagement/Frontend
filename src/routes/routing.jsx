...
const appRoutes = [
  ...
  { path: '/create-trust', permissions: [0, 1], name: 'Create Trust', icon: 'pe-7s-user', component: CreateTrust },
  { path: '/trust-listing', permissions: [0, 1], name: 'Trust Listing', icon: 'pe-7s-user', component: TrustListing },
